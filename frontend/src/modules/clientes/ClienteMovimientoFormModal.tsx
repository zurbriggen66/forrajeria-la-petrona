...
import { useCrearMovimientoCliente } from './api'

export function ClienteMovimientoFormModal({
  clienteId, tipo, onClose,
}: {
  clienteId: string
  tipo: 'pago' | 'ajuste'
  onClose: () => void
  ...
  return (
    <Modal title={tipo === 'pago' ? 'Registrar pago del cliente' : 'Ajuste de cuenta corriente'} onClose={onClose}>
